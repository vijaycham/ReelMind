  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute p-6 md:p-12 bg-black w-full md:w-4/12 lg:w-3/12 my-24 md:my-36 mx-auto right-0 left-0 text-white bg-opacity-80 rounded-xl shadow-2xl border border-gray-800"
      >
